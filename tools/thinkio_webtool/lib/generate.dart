...
void generate_sitemap(Uri baseU, Directory base, Iterable<String> dataPath){
  ...
  print("base.uri: Uri");
  print(base.uri.pathSegments);
  genSitemap(baseU, out, data.construct<BlogRec>(BlogRec.fromYaml, needSort: true, reverse: true));
}
